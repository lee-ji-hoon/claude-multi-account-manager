...
**Claude Code 대화창에서:**
```
/marketplace add lee-ji-hoon https://github.com/lee-ji-hoon/claude-multi-account-manager.git
/plugin install account@lee-ji-hoon
```
...
설치 후 Claude Code를 재시작하면 `/account:list` 명령어 사용 가능!
...
├── commands/
│   ├── list.md              # /account:list
│   ├── add.md               # /account:add
│   ├── switch.md            # /account:switch
│   ├── check.md             # /account:check
│   ├── remove.md            # /account:remove
│   └── set-plan.md          # /account:set-plan
├── hooks/
...
```bash
# 마켓플레이스 설치의 경우
claude plugin uninstall account@lee-ji-hoon
